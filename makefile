...
local-remove-apps   := Apollo Gallery2 Stk Launcher3 VideoEditor PicoTts HoloSpiralWallpaper MagicSmokeWallpapers Nfc \
			PhaseBeam Galaxy4 NoiseField Exchange2 BasicDreams LatinIME  CMFileManger CMHome CMWallpepers \
			 DSPManager Term  Torch
...
#	rm -rf $(ZIP_DIR)/data/miui/apps/*.apk
	...
	rm -rf $(ZIP_DIR)/system/priv-app/Trebuchet.apk
